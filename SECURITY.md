...
Only the latest published minor version of each package receives security fixes. Upgrade before reporting if possible.

## Scope

In scope: this repository's source code and its published npm artifacts.
